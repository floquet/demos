      SUBROUTINE PFDGETRS( TRANS, N, NRHS, A, IA, JA, DESCA, IPIV, B,
     $                     IB, JB, DESCB, INFO )
*
*
...
*     .. External Subroutines ..
     ...
     $                   LAIO_INFO, PCHK1MAT, PDLAPIV, PFDTRSM, PXERBLA
*     ..
*     .. Intrinsic Functions ..
...
*
     ...
     $          LSAME( TRANS, 'N' ) )
      IF( .NOT.ISVALID ) THEN
         INFO = -1
         CALL PXERBLA( DESCA( CTXT_ ), 'PFDGETRS', 1 )
         RETURN
      ENDIF
      SAVEDT = DESCA( DT_ )
      ...
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( DESCA( CTXT_ ), 'PFDGETRS', 7 )
         RETURN
      ENDIF
      IDUMMY = 1
     ...
     $               IDUMMY, INFO )
      ...
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( DESCB( CTXT_ ), 'PFDGETRS', 11 )
         RETURN
      ENDIF
      IDUMMY = 1
...
*
*
         CALL PFDTRSM( 'Left', 'Lower', 'No transpose', 'Unit', N, NRHS,
...
*
*
         CALL PFDTRSM( 'Left', 'Upper', 'No transpose', 'Non-unit', N,
...
*
*
         CALL PFDTRSM( 'Left', 'Upper', TRANS, 'Non-unit', N, NRHS, ONE,
...
*
*
         CALL PFDTRSM( 'Left', 'Lower', TRANS, 'Unit', N, NRHS, ONE, A,
