      SUBROUTINE PFCLAPRNT2( M, N, IAOFF, JAOFF, A, IA, JA, DESCA,
...
*     .. External Subroutines ..
      EXTERNAL           BLACS_BARRIER, BLACS_GRIDINFO, CGERV2D,
     $                   CGESD2D, INFOG2L
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          AIMAG, DBLE, MIN, MOD
*     ..
