      SUBROUTINE PFZGELUP( M, N, CWORK, IC, JC, DESCC, IPIV, JSIZEB,
...
*     .. External Subroutines ..
     ...
     $                   LAIO_INFO, PFMAXSIZE, PZGEMM, PZLAPIV, PZTRSM,
     $                   ZLAREAD
*     ..
*     .. Intrinsic Functions ..
...
*
      ...
      NN = JSIZEB
      CALL PZLAPIV( 'Forward', 'Rowise', 'Columwise', MM, NN, BMAT, IB,
...
*
            ...
            IF( HASWORK ) THEN
               IIB = ( IB-1 ) + JSTARTA
               JJB = ( JB-1 ) + 1
               CALL PZLAPIV( 'Forward', 'Rowwise', 'Columnwise', MM, NN,
...
*
     ...
     $                , IASIZE )
         ...
         HASWORK = ( MM.GE.1 ) .AND. ( NN.GE.1 )
         IF( HASWORK ) THEN
            CALL PZTRSM( 'Leftside', 'LowerTriangular', 'NoTranspose',
