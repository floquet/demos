      SUBROUTINE PFSPOTRS( UPLO, N, NRHS, A, IA, JA, DESCA, B, IB, JB,
     $                     DESCB, INFO )
*
*
...
*
     ...
     $                     MYPCOL )
      ...
      IF( .NOT.ISVALID ) THEN
         INFO = -1
         CALL PXERBLA( DESCA( CTXT_ ), 'PFSPOTRS', 1 )
         RETURN
      ENDIF
      SAVEDT = DESCA( DT_ )
      ...
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( DESCA( CTXT_ ), 'PFSPOTRS', 7 )
         RETURN
      ENDIF
      IDUMMY = 1
     ...
     $               IDUMMY, INFO )
      ...
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( DESCB( CTXT_ ), 'PFSPOTRS', 11 )
         RETURN
      ENDIF
      IDUMMY = 1
...
*
*
         CALL PFSTRSM( 'Left', 'Upper', 'T', 'Non-unit', N, NRHS, ONE,
...
*
*
         CALL PFSTRSM( 'Left', 'Lower', 'No transpose', 'Non-unit', N,
     $                 NRHS, ONE, A, IA, JA, DESCA, B, IB, JB, DESCB,
     $                 WORK, LWORK, INFO )
*
*
...
*
*
         CALL PFSTRSM( 'Left', 'Lower', 'T', 'Non-unit', N, NRHS, ONE,
     $                 A, IA, JA, DESCA, B, IB, JB, DESCB, WORK, LWORK,
     $                 INFO )
      ENDIF
      RETURN
