      SUBROUTINE PFZGETRS( TRANS, N, NRHS, A, IA, JA, DESCA, IPIV, B,
     $                     IB, JB, DESCB, INFO )
*
*
...
*     .. External Subroutines ..
     ...
     $                   LAIO_INFO, PCHK1MAT, PFZTRSM, PXERBLA, PZLAPIV
*     ..
*     .. Intrinsic Functions ..
...
*
     ...
     $          LSAME( TRANS, 'N' ) )
      IF( .NOT.ISVALID ) THEN
         INFO = -1
         CALL PXERBLA( DESCA( CTXT_ ), 'PFZGETRS', 1 )
         RETURN
      ENDIF
      SAVEDT = DESCA( DT_ )
      ...
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( DESCA( CTXT_ ), 'PFZGETRS', 7 )
         RETURN
      ENDIF
      IDUMMY = 1
     ...
     $               IDUMMY, INFO )
      ...
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( DESCB( CTXT_ ), 'PFZGETRS', 11 )
         RETURN
      ENDIF
      IDUMMY = 1
...
*
*
         CALL PZLAPIV( 'Forward', 'Row', 'Col', N, NRHS, B, IB, JB,
...
*
*
         CALL PFZTRSM( 'Left', 'Lower', 'No transpose', 'Unit', N, NRHS,
...
*
*
         CALL PFZTRSM( 'Left', 'Upper', TRANS, 'Non-unit', N, NRHS, ONE,
...
*
*
         CALL PFZTRSM( 'Left', 'Lower', TRANS, 'Unit', N, NRHS, ONE, A,
...
*
*
         CALL PZLAPIV( 'Backward', 'Row', 'Col', N, NRHS, B, IB, JB,
     $                 DESCB, IPIV, IA, 1, DESCIP, IWORK )
      ENDIF
      RETURN
      END
