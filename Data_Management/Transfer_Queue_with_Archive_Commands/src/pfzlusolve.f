      SUBROUTINE PFZLUSOLVE( IODEV, M, NRHS, IA, JA, DESCA, IPIV, B, IB,
     $                       JB, DESCB, WORK, LWORK )
*
*
...
*
     ...
     $             INFO )
      CALL PZLAPIV( 'Forward', 'Row', 'Col', M, NRHS, B, IB, JB, DESCB,
     $              IPIV, IA, 1, DESCIPIV, IDUM1 )
      ...
      DIAG = 'U'
      SIDE = 'L'
      CALL PFZLATRSM( SIDE, UPLO, TRANS, DIAG, IODEV, M, NRHS, IA, JA,
