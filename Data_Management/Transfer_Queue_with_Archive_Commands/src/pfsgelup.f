      SUBROUTINE PFSGELUP( M, N, CWORK, IC, JC, DESCC, IPIV, JSIZEB,
...
*     .. External Subroutines ..
      EXTERNAL           ASSERT, BLACS_GRIDINFO, DESCINIT, INFOG1L,
     $                   LAIO_INFO, PFMAXSIZE, PSGEMM, PSLAPIV, PSTRSM,
     $                   SLAREAD
*     ..
*     .. Intrinsic Functions ..
...
*
      ...
      NN = JSIZEB
      CALL PSLAPIV( 'Forward', 'Rowise', 'Columwise', MM, NN, BMAT, IB,
...
*
            ...
            IF( HASWORK ) THEN
               IIB = ( IB-1 ) + JSTARTA
               JJB = ( JB-1 ) + 1
               CALL PSLAPIV( 'Forward', 'Rowwise', 'Columnwise', MM, NN,
...
*
     ...
     $                , IASIZE )
         ...
         HASWORK = ( MM.GE.1 ) .AND. ( NN.GE.1 )
         IF( HASWORK ) THEN
            CALL PSTRSM( 'Leftside', 'LowerTriangular', 'NoTranspose',
