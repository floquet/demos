      SUBROUTINE PFSCOPYTAU( M, IA, TAUA, DESCA, IB, TAUB, DESCB )
*
*
...
*     .. External Subroutines ..
      EXTERNAL           BLACS_GRIDINFO, INFOG1L, SFILL, SGAMX2D,
     $                   SGSUM2D
*     ..
*     .. Intrinsic Functions ..
   ...
   20       CONTINUE
      ...
      ELSE
         DO 70 ISTART = IA, IA + M - 1, NDIM
            ...
            ISIZE = IEND - ISTART + 1
            CALL SFILL( NDIM, DZERO, GTAU( 1 ), 1 )
