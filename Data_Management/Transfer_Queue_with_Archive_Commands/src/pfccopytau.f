      SUBROUTINE PFCCOPYTAU( M, IA, TAUA, DESCA, IB, TAUB, DESCB )
*
*
...
*     .. External Subroutines ..
      EXTERNAL           BLACS_GRIDINFO, CFILL, CGAMX2D, CGSUM2D,
     $                   INFOG1L
*     ..
*     .. Intrinsic Functions ..
   ...
   20       CONTINUE
      ...
      ELSE
         DO 70 ISTART = IA, IA + M - 1, NDIM
            ...
            ISIZE = IEND - ISTART + 1
            CALL CFILL( NDIM, DZERO, GTAU( 1 ), 1 )
