      SUBROUTINE PFDQRSOLVE( IODEV, M, N, NRHS, IC, JC, DESCC, TAUC, A,
...
*     .. Array Arguments ..
      ...
      DOUBLE PRECISION   A( * ), B( * ), TAUC( * ), WORK( * )
*     ..
*     .. Local Scalars ..
...
* perform Householder reduction
     ...
     $                     MYPCOL )
      ...
      DESC( IODEV_ ) = IODEV
      DESC( SIZE_ ) = ASIZE
      CALL PFDORMQR( 'Left', 'T', MM, NN, KK, A, IC, JC, DESC, TAUC, B,
     ...
     $       NPCOL )
      ...
      NN = NRHS
      ALPHA = ONE
      CALL PFDLATRSM( 'L', 'U', 'N', 'N', IODEV, MM, NN, IC, JC, ALPHA,
