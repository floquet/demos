      SUBROUTINE PFCQRSOLVE( IODEV, M, N, NRHS, IC, JC, DESCC, TAUC, A,
...
* perform Householder reduction
     ...
     $                     MYPCOL )
      ...
      DESC( IODEV_ ) = IODEV
      DESC( SIZE_ ) = ASIZE
      CALL PFCUNMQR( 'Left', 'C', MM, NN, KK, A, IC, JC, DESC, TAUC, B,
     ...
     $       NPCOL )
      ...
      NN = NRHS
      ALPHA = ONE
      CALL PFCLATRSM( 'L', 'U', 'N', 'N', IODEV, MM, NN, IC, JC, ALPHA,
