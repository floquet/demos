      SUBROUTINE PFDLATRSM( SIDE, UPLO, TRANS, DIAG, IODEV, M, N, IC,
...
*     .. External Subroutines ..
     ...
     $                   DLAREAD, LAIO_INFO, PDGEMM, PDSCAL, PDTRSM,
     $                   PFMAXSIZE, PXERBLA
*     ..
*     .. Intrinsic Functions ..
...
*
      ...
      IF( LWORK.LT.INEED ) THEN
         ...
         IF( .NOT.LWORKQUERY ) THEN
            CALL PXERBLA( DESCB( CTXT_ ), 'PFDLATRSM', 16 )
         ENDIF
         RETURN
      ENDIF
...
* 1:jend
     ...
     $                  LDA, INFO )
         ...
         MM = ISIZE
         NN = JSIZE
         CALL DLAREAD( IODEV, ISIZE, JSIZE, ICPOS, JCPOS,
