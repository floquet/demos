      SUBROUTINE PFSQRAPPLY( IODEV, M, N, K, IC, JC, DESCC, TAUC, A,
...
*     .. External Subroutines ..
      EXTERNAL           ASSERT, BLACS_PINFO, PFSCOPYTAU, PSORMQR,
     $                   SFILL, SLAREAD
*     ..
*     .. Intrinsic Functions ..
...
* not sure whether it should be ia = 1
         ...
         JCPOS = ( JC-1 ) + JSTARTA
         INFO = 0
         CALL SLAREAD( IODEV, ISIZEA, JSIZEA, ICPOS, JCPOS, A, IA, JA,
     $                 DESCA, INFO )
...
* copy tau
     ...
     $                '** qrapply: increase gtau_dim to ', JSIZEA+1 )
         CALL SFILL( TAUA_DIM, DZERO, TAUA( 1 ), 1 )
         JA = 1
         CALL PFSCOPYTAU( JSIZEA, JCPOS, TAUC, DESCC, JA, TAUA( 1 ),
     $                    DESCA )
*
...
*
     ...
     $             ( JSIZEA.GE.1 )
         IF( HASWORK ) THEN
            ...
            SIDE = 'L'
            TRANS = 'T'
            CALL PSORMQR( SIDE, TRANS, MM, NN, KK, A, IA, JA, DESCA,
