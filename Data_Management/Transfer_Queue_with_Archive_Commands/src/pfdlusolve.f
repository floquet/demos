      SUBROUTINE PFDLUSOLVE( IODEV, M, NRHS, IA, JA, DESCA, IPIV, B, IB,
     $                       JB, DESCB, WORK, LWORK )
*
*
...
*     .. Local Scalars ..
     ...
     $                   NROW, P0, Q0
      DOUBLE PRECISION   DALPHA, ONE, ZERO
*     ..
*     .. Local Arrays ..
...
*
     ...
     $             INFO )
      CALL PDLAPIV( 'Forward', 'Row', 'Col', M, NRHS, B, IB, JB, DESCB,
     $              IPIV, IA, 1, DESCIPIV, IDUM1 )
      ...
      DIAG = 'U'
      SIDE = 'L'
      CALL PFDLATRSM( SIDE, UPLO, TRANS, DIAG, IODEV, M, NRHS, IA, JA,
