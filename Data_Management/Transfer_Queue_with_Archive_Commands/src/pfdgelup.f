      SUBROUTINE PFDGELUP( M, N, CWORK, IC, JC, DESCC, IPIV, JSIZEB,
...
*     .. External Subroutines ..
     ...
     $                   INFOG1L, LAIO_INFO, PDGEMM, PDLAPIV, PDTRSM,
     $                   PFMAXSIZE
*     ..
*     .. Intrinsic Functions ..
...
*
      ...
      NN = JSIZEB
      CALL PDLAPIV( 'Forward', 'Rowise', 'Columwise', MM, NN, BMAT, IB,
...
*
            ...
            IF( HASWORK ) THEN
               IIB = ( IB-1 ) + JSTARTA
               JJB = ( JB-1 ) + 1
               CALL PDLAPIV( 'Forward', 'Rowwise', 'Columnwise', MM, NN,
...
*
     ...
     $                , IASIZE )
         ...
         HASWORK = ( MM.GE.1 ) .AND. ( NN.GE.1 )
         IF( HASWORK ) THEN
            CALL PDTRSM( 'Leftside', 'LowerTriangular', 'NoTranspose',
