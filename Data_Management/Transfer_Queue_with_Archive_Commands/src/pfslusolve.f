      SUBROUTINE PFSLUSOLVE( IODEV, M, NRHS, IA, JA, DESCA, IPIV, B, IB,
     $                       JB, DESCB, WORK, LWORK )
*
*
...
*
     ...
     $             INFO )
      CALL PSLAPIV( 'Forward', 'Row', 'Col', M, NRHS, B, IB, JB, DESCB,
     $              IPIV, IA, 1, DESCIPIV, IDUM1 )
      ...
      DIAG = 'U'
      SIDE = 'L'
      CALL PFSLATRSM( SIDE, UPLO, TRANS, DIAG, IODEV, M, NRHS, IA, JA,
