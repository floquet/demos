      SUBROUTINE PSBMATGEN( ICTXT, AFORM, DIAG, BWL, BWU, N, MB, NB, A,
...
*  =======
*
*  PSBMATGEN : Parallel Real Single precision Band MATrix GENerator.
...
*  =====
*
*  This code is a simple wrapper around PSMATGEN, for band matrices.
*
*  =====================================================================
*
...
*
         CALL PSMATGEN( ICTXT, 'T', 'N', N_MATGEN, M_MATGEN, NB,
...
*
      ELSE
*
         CALL PSMATGEN( ICTXT, 'N', 'N', M_MATGEN, N_MATGEN, M_MATGEN,
