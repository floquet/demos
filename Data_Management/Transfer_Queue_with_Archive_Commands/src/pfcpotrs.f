      SUBROUTINE PFCPOTRS( UPLO, N, NRHS, A, IA, JA, DESCA, B, IB, JB,
     $                     DESCB, INFO )
*
*
...
*
     ...
     $                     MYPCOL )
      ...
      IF( .NOT.ISVALID ) THEN
         INFO = -1
         CALL PXERBLA( DESCA( CTXT_ ), 'PFCPOTRS', 1 )
         RETURN
      ENDIF
      SAVEDT = DESCA( DT_ )
      ...
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( DESCA( CTXT_ ), 'PFCPOTRS', 7 )
         RETURN
      ENDIF
      IDUMMY = 1
     ...
     $               IDUMMY, INFO )
      ...
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( DESCB( CTXT_ ), 'PFCPOTRS', 11 )
         RETURN
      ENDIF
      IDUMMY = 1
...
*
*
         CALL PFCTRSM( 'Left', 'Upper', 'C', 'Non-unit', N, NRHS, ONE,
...
*
*
         CALL PFCTRSM( 'Left', 'Lower', 'No transpose', 'Non-unit', N,
     $                 NRHS, ONE, A, IA, JA, DESCA, B, IB, JB, DESCB,
     $                 WORK, LWORK, INFO )
*
*
...
*
*
         CALL PFCTRSM( 'Left', 'Lower', 'C', 'Non-unit', N, NRHS, ONE,
     $                 A, IA, JA, DESCA, B, IB, JB, DESCB, WORK, LWORK,
     $                 INFO )
      ENDIF
      RETURN
