      SUBROUTINE PFCLAPRNT( M, N, A, IA, JA, DESCA, IRPRNT, ICPRNT,
     $                      CMATNM, NOUT, WORK )
*
*
...
*     .. External Subroutines ..
     ...
     $                   DESCINIT, LAIO_INFO, PCHK1MAT, PFCLAPRNT2,
     $                   PXERBLA
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX, MIN
...
*     .. Executable Statements ..
     ...
     $                     MYPCOL )
      ...
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( DESCA( CTXT_ ), 'PFCLAPRNT', 6 )
         RETURN
      ENDIF
      IDUMMY = 1
...
*
      ...
      DO 30 JSTART = 1, N, NNB
         ...
         DO 10 ISTART = 1, M, MMB
            ...
            IF( HASWORK ) THEN
               ...
               IIA = ( IA-1 ) + ISTART
               JJA = ( JA-1 ) + JSTART
               CALL CLAREAD( IODEV, ISIZE, JSIZE, IIA, JJA, A, 1, 1,
     $                       DESCATMP, INFO )
     ...
     $                      , INFO )
               IAOFF = IIA - 1
               JAOFF = JJA - 1
               CALL PFCLAPRNT2( ISIZE, JSIZE, IAOFF, JAOFF, A, 1, 1,
