      SUBROUTINE PFSQRSOLVE( IODEV, M, N, NRHS, IC, JC, DESCC, TAUC, A,
...
* perform Householder reduction
     ...
     $                     MYPCOL )
      ...
      DESC( IODEV_ ) = IODEV
      DESC( SIZE_ ) = ASIZE
      CALL PFSORMQR( 'Left', 'T', MM, NN, KK, A, IC, JC, DESC, TAUC, B,
     ...
     $       NPCOL )
      ...
      NN = NRHS
      ALPHA = ONE
      CALL PFSLATRSM( 'L', 'U', 'N', 'N', IODEV, MM, NN, IC, JC, ALPHA,
