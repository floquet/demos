      SUBROUTINE PFCGETRS( TRANS, N, NRHS, A, IA, JA, DESCA, IPIV, B,
     $                     IB, JB, DESCB, INFO )
*
*
...
*     .. External Subroutines ..
     ...
     $                   LAIO_INFO, PCHK1MAT, PCLAPIV, PFCTRSM, PXERBLA
*     ..
*     .. Intrinsic Functions ..
...
*
     ...
     $          LSAME( TRANS, 'N' ) )
      IF( .NOT.ISVALID ) THEN
         INFO = -1
         CALL PXERBLA( DESCA( CTXT_ ), 'PFCGETRS', 1 )
         RETURN
      ENDIF
      SAVEDT = DESCA( DT_ )
      ...
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( DESCA( CTXT_ ), 'PFCGETRS', 7 )
         RETURN
      ENDIF
      IDUMMY = 1
     ...
     $               IDUMMY, INFO )
      ...
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( DESCB( CTXT_ ), 'PFCGETRS', 11 )
         RETURN
      ENDIF
      IDUMMY = 1
...
*
*
         CALL PFCTRSM( 'Left', 'Lower', 'No transpose', 'Unit', N, NRHS,
...
*
*
         CALL PFCTRSM( 'Left', 'Upper', 'No transpose', 'Non-unit', N,
...
*
*
         CALL PFCTRSM( 'Left', 'Upper', TRANS, 'Non-unit', N, NRHS, ONE,
...
*
*
         CALL PFCTRSM( 'Left', 'Lower', TRANS, 'Unit', N, NRHS, ONE, A,
